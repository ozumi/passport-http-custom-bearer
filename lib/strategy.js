 ...
 * `headerName` option (defaults to `Authorization`), custom-named body
 * parameter given by the `bodyName` option (defaults to `access_token`),
 * or a custom-named query parameter given by the `queryName` option
...
function Strategy(options, verify) {
  ...
  this._bodyName = options.bodyName || 'access_token';
  this._queryName = options.queryName || 'access_token';
